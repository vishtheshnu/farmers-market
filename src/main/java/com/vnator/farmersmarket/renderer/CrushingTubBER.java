package com.vnator.farmersmarket.renderer;
...
public class CrushingTubBER implements BlockEntityRenderer<CrushingTubBE> {
    ...
    public void render(
        ...
        ItemStack stackToRender = entity.getItemHandler().getStackInSlot(0);
        ...
        for(int i = 0; i < entity.getItemHandler().getStackInSlot(0).getCount(); i++){
            if(stackToRender.getItem() instanceof BlockItem){
                if((i) % 16 == 0){
